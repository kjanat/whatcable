...
struct USB3TransportTests {
    ...
    func gen1SpeedLabel() {
        let t = USB3Transport(
            id: 1, portKey: "2/1", signaling: 1, signalingDescription: "Gen 1", dataRole: "host")
    ...
    func gen2SpeedLabel() {
        let t = USB3Transport(
            id: 2, portKey: "2/1", signaling: 2, signalingDescription: "Gen 2", dataRole: "host")
    ...
    func unknownSignalingFallsBackToGenericLabel() {
        let t = USB3Transport(
            id: 3, portKey: "2/1", signaling: 5, signalingDescription: nil, dataRole: nil)
    ...
    func nilSignalingReturnsNil() {
        let t = USB3Transport(
            id: 4, portKey: "2/1", signaling: nil, signalingDescription: nil, dataRole: nil)
    ...
    func zeroSignalingReturnsNil() {
        ...
        let t = USB3Transport(
            id: 5, portKey: "2/1", signaling: 0, signalingDescription: "None", dataRole: "host")
        #expect(t.speedLabel == nil)
    }
    ...
    func equalTransportsAreEqual() {
        let a = USB3Transport(
            id: 10, portKey: "2/1", signaling: 1, signalingDescription: "Gen 1", dataRole: "host")
        let b = USB3Transport(
            id: 10, portKey: "2/1", signaling: 1, signalingDescription: "Gen 1", dataRole: "host")
        #expect(a == b)
    }
    ...
    func differentIDsAreNotEqual() {
        let a = USB3Transport(
            id: 10, portKey: "2/1", signaling: 1, signalingDescription: "Gen 1", dataRole: "host")
        let b = USB3Transport(
            id: 11, portKey: "2/1", signaling: 1, signalingDescription: "Gen 1", dataRole: "host")
        #expect(a != b)
    }
    ...
    func hashableUsableInSet() {
        let a = USB3Transport(
            id: 10, portKey: "2/1", signaling: 1, signalingDescription: "Gen 1", dataRole: "host")
        let b = USB3Transport(
            id: 11, portKey: "2/2", signaling: 2, signalingDescription: "Gen 2", dataRole: "device")
    ...
    func identifiableID() {
        let t = USB3Transport(
            id: 42, portKey: "2/3", signaling: 1, signalingDescription: nil, dataRole: nil)
        #expect(t.id == 42)
    }
}
